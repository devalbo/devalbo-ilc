...
import { emit } from '@devalbo/dlc-web/events';
const { getArguments,
  getEnvironment,
...
_trampoline2.fnName = 'wasi:cli/stdout@0.2.0#getStdout';
...
_trampoline3.fnName = 'wasi:clocks/monotonic-clock@0.2.0#now';
...
_trampoline4.fnName = 'wasi:random/random@0.2.0#getRandomU64';
...
_trampoline5.fnName = 'wasi:cli/stderr@0.2.0#getStderr';
...
_trampoline9.fnName = 'wasi:cli/environment@0.2.0#getEnvironment';
...
_trampoline10.fnName = 'wasi:cli/environment@0.2.0#getArguments';
...
_trampoline11.fnName = 'wasi:cli/environment@0.2.0#initialCwd';
...
_trampoline12.fnName = 'wasi:io/streams@0.2.0#blockingRead';
...
_trampoline13.fnName = 'wasi:io/streams@0.2.0#blockingFlush';
...
_trampoline14.fnName = 'wasi:io/streams@0.2.0#blockingWriteAndFlush';
...
_trampoline16.fnName = 'wasi:random/random@0.2.0#getRandomBytes';
...
_trampoline17.fnName = 'wasi:filesystem/types@0.2.0#createDirectoryAt';

const _trampoline18 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
  var handle1 = arg0;
...
_trampoline18.fnName = 'wasi:filesystem/types@0.2.0#linkAt';

const _trampoline19 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
...
_trampoline19.fnName = 'wasi:filesystem/types@0.2.0#openAt';
...
_trampoline20.fnName = 'wasi:filesystem/types@0.2.0#read';
...
_trampoline21.fnName = 'wasi:filesystem/types@0.2.0#readDirectory';
...
_trampoline22.fnName = 'wasi:filesystem/types@0.2.0#readlinkAt';
...
_trampoline23.fnName = 'wasi:filesystem/types@0.2.0#removeDirectoryAt';

const _trampoline24 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
...
_trampoline24.fnName = 'wasi:filesystem/types@0.2.0#renameAt';
...
_trampoline25.fnName = 'wasi:filesystem/types@0.2.0#stat';
...
_trampoline26.fnName = 'wasi:filesystem/types@0.2.0#statAt';
...
_trampoline27.fnName = 'wasi:filesystem/types@0.2.0#symlinkAt';
...
_trampoline28.fnName = 'wasi:filesystem/types@0.2.0#syncData';
...
_trampoline29.fnName = 'wasi:filesystem/types@0.2.0#unlinkFileAt';

const _trampoline30 = function(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
...
_trampoline30.fnName = 'wasi:filesystem/types@0.2.0#write';
...
_trampoline31.fnName = 'wasi:filesystem/types@0.2.0#readDirectoryEntry';
...
_trampoline32.fnName = 'wasi:filesystem/preopens@0.2.0#getDirectories';
...
const _trampoline33 = function(arg0, arg1, arg2, arg3) {
  ...
  _debugLog('[iface="devalbo:ilc/events", function="emit"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  _debugLog('[iface="devalbo:ilc/events", function="emit"][Instruction::Return]', {
    funcName: 'emit',
    paramCount: 0,
    async: false,
    postReturn: false
...
_trampoline33.fnName = 'devalbo:ilc/events#emit';
let exports2;
let exports3;
let exports1Execute;
...
function execute(arg0, arg1) {
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1Execute(toUint32(arg0), ptr0, len0),
    });
  } catch (err) {
  ...
  task.resolve([{
    success: bool1 == 0 ? false : (bool1 == 1 ? true : throwInvalidBool()),
    output: result2,
    error: variant4,
  }]);
  task.exit();
...
null,
{
  ...
  paramLiftFns: [_liftFlatBorrow.bind(null, 3),_liftFlatStringAny],
  resultLowerFns: [
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', null, 2, 1, 1 ],
...
null,
{
  ...
  paramLiftFns: [_liftFlatBorrow.bind(null, 3),_liftFlatFlags({ names: ['symlinkFollow'], size32: 1, align32: 1, intSizeBytes: 1 }),_liftFlatStringAny,_liftFlatBorrow.bind(null, 3),_liftFlatStringAny],
  resultLowerFns: [
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', null, 2, 1, 1 ],
...
null,
{
  ...
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', _lowerFlatTuple({ elemLowerMetas: [[_lowerFlatList({
      elemLowerFn: _lowerFlatU8,
      elemSize32: 1,
      elemAlign32: 1,
    }), 8, 4],[_lowerFlatBool, 1, 1],], size32: 12, align32: 4 }), 16, 4, 4 ],
    [ 'err', 
    _lowerFlatEnum({
      caseMetas: [['access', null, 1, 1, 1],['would-block', null, 1, 1, 1],['already', null, 1, 1, 1],['bad-descriptor', null, 1, 1, 1],['busy', null, 1, 1, 1],['deadlock', null, 1, 1, 1],['quota', null, 1, 1, 1],['exist', null, 1, 1, 1],['file-too-large', null, 1, 1, 1],['illegal-byte-sequence', null, 1, 1, 1],['in-progress', null, 1, 1, 1],['interrupted', null, 1, 1, 1],['invalid', null, 1, 1, 1],['io', null, 1, 1, 1],['is-directory', null, 1, 1, 1],['loop', null, 1, 1, 1],['too-many-links', null, 1, 1, 1],['message-size', null, 1, 1, 1],['name-too-long', null, 1, 1, 1],['no-device', null, 1, 1, 1],['no-entry', null, 1, 1, 1],['no-lock', null, 1, 1, 1],['insufficient-memory', null, 1, 1, 1],['insufficient-space', null, 1, 1, 1],['not-directory', null, 1, 1, 1],['not-empty', null, 1, 1, 1],['not-recoverable', null, 1, 1, 1],['unsupported', null, 1, 1, 1],['no-tty', null, 1, 1, 1],['no-such-device', null, 1, 1, 1],['overflow', null, 1, 1, 1],['not-permitted', null, 1, 1, 1],['pipe', null, 1, 1, 1],['read-only', null, 1, 1, 1],['invalid-seek', null, 1, 1, 1],['text-file-busy', null, 1, 1, 1],['cross-device', null, 1, 1, 1],],
      variantSize32: 1,
...
null,
{
  ...
  paramLiftFns: [_liftFlatBorrow.bind(null, 3),_liftFlatStringAny,_liftFlatBorrow.bind(null, 3),_liftFlatStringAny],
  resultLowerFns: [
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', null, 2, 1, 1 ],
...
null,
{
  ...
  paramLiftFns: [_liftFlatBorrow.bind(null, 3),_liftFlatFlags({ names: ['symlinkFollow'], size32: 1, align32: 1, intSizeBytes: 1 }),_liftFlatStringAny],
  resultLowerFns: [
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', _lowerFlatRecord({ fieldMetas: [['type', 
...
null,
{
  ...
  paramLiftFns: [_liftFlatBorrow.bind(null, 3),_liftFlatStringAny,_liftFlatStringAny],
  resultLowerFns: [
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', null, 2, 1, 1 ],
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./engine.component.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('');

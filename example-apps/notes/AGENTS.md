# AGENTS.md — rules for working on notes
...
notes is an **ILC** app: business logic lives once, in `engine/`, and every tier drives it through
...
`*.registry.pb.ts`. Add an rpc to `proto/notes/v1/commands.proto`, run `make gen`, and the constant

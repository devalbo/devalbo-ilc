...
// Wasip2 component entrypoint for tictactoe — the artifact the browser loads.
//
...
import (
	_ "github.com/devalbo/devalbo-ilc/example-apps/tictactoe/engine" // registers this app's commands

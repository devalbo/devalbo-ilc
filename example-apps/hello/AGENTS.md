# AGENTS.md — rules for working on hello
...
hello is an **ILC** app: business logic lives once, in `engine/`, and every tier drives it through
...
`*.registry.pb.ts`. Add an rpc to `proto/hello/v1/commands.proto`, run `make gen`, and the constant

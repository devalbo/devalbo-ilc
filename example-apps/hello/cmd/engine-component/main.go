...
// Wasip2 component entrypoint for hello — the artifact the browser loads.
//
...
import (
	_ "github.com/devalbo/devalbo-ilc/example-apps/hello/engine" // registers this app's commands
